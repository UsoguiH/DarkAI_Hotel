			...
			{isTransitioning ? (
				<div className="text-container">
					{oldText && (
						<span
							ref={contentRef}
							className={`text-content old ${isStrikethrough ? 'strikethrough' : ''
			...
			{!loading && isMobile && !isEndAnimationPlaying && (
				...
				>
					<div className="mobile-buttons left">
						<button
							className={`mobile-button top ${activeButtons.rightClick ? 'active' : ''
								}`}
							onTouchStart={() => {
						...
						<button
							className={`mobile-button bottom ${activeButtons.leftClick ? 'active' : ''
								}`}
							onTouchStart={() => {
					...
					<div className="mobile-buttons right">
						<button
							className={`mobile-button top ${activeButtons.jump ? 'active' : ''
								}`}
							onTouchStart={() => {
						...
						<button
							className={`mobile-button bottom ${activeButtons.crouch ? 'active' : ''
								}`}
							onTouchStart={() => {
